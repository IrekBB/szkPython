...
root.mainloop()
"""
Combobox widgets can also be editable, allowing users to enter values not currently in the list. 
To achieve this, you need to set the state argument to "normal":
